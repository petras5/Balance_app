...
try {
    ...
    exit("PDO error [create dz2_users]: " . $e->getMessage());
}
...
try {
    ...
    exit("PDO error [create dz2_expenses]: " . $e->getMessage());
}
...
try {
    ...
    exit("PDO error [create parts]: " . $e->getMessage());
}
...
try {
    ...
    exit("PDO error [insert dz2_users]: " . $e->getMessage());
}

echo "Ubacio u tablicu dz2_users.<br />";


// Ubaci neke račune unutra (ovo nije baĹˇ pametno ovako raditi, preko hardcodiranih id-eva usera):
try {
    ...
    exit("PDO error [dz2_expenses]: " . $e->getMessage());
}
...
try {
    ...
    exit("PDO error [dz2_parts]: " . $e->getMessage());
}
